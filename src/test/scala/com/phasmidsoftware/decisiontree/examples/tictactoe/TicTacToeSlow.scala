...
//
//  trait TicTacToeSlowState$ extends State[Board, TicTacToeSlow] {
//
//    /**
...
//     * @param so an optional S.
//     * @return an S.
//     */
//    def construct(p: Board, q: PriorityQueue[TicTacToeSlow], so: Option[TicTacToeSlow]): TicTacToeSlow = ???
//
//    /**
...
//     */
//    def previous(s: TicTacToeSlow): Option[TicTacToeSlow] = ???
//
//    /**
...
//     */
//    def pq(s: TicTacToeSlow): PriorityQueue[TicTacToeSlow] = ???
//
//    /**
